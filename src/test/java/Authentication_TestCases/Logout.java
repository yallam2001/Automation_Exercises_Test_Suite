...
//    @Description(
//            "This test case examines whether the logout button functions as expected or not")
...
//        String ActualURL_login = h.clickLogoutButton();
//        String ExpectedURL_login = "https://automationexercise.com/login";
//        Assert.assertTrue(ActualURL_login.contains(ExpectedURL_login),
//                ActualURL_login + " should contain " + ExpectedURL_login);
//    }
...
//        continueAfterAccountCreated();
    ...
    public void verifyLoggedInAs() {
        ...
        AllureUtil.takeScreenshot(Browser, "Logged In Confirmation");
    }

//    @Step("Click logout button")
//    public void performLogout() {
//        h.clickLogoutButton();
//        AllureUtil.takeScreenshot(Browser, "Logout Clicked");
//    }

    @Step("Verify redirection to login page")
    public void verifyRedirectToLoginPage() {
        String actualURL = h.clickLogoutButton();
        String expectedURL = "https://automationexercise.com/login";
        Assert.assertTrue(actualURL.contains(expectedURL),
                actualURL + " should contain " + expectedURL);
        AllureUtil.takeScreenshot(Browser, "Redirected to Login Page");
    }
