...
public class OrderHelperClass {
    ...
    public static LoginCheckoutUser[] ReadLoginCheckoutData(String fileName) throws FileNotFoundException {
        FileReader reader = new FileReader(
                TestPrjRoot + TestDataFolder + fileName);
        LoginCheckoutUser[] CheckoutUser = new Gson().fromJson(reader,
    ...
    public static RegisterCheckoutUser[] ReadRegisterWhileCheckoutData(
        ...
        FileReader reader = new FileReader(
                TestPrjRoot + TestDataFolder + fileName);
        RegisterCheckoutUser[] register_checkout_user = new Gson().fromJson(
    ...
    public static RegisterBeforeCheckoutUser[] ReadRegisterBeforeCheckoutData(
        ...
        RegisterBeforeCheckoutUser[] RegisterBeforeCheckoutUsers = new Gson().
                fromJson(reader, RegisterBeforeCheckoutUser[].class);
